  ...
  return (
    <div className="mx-auto max-w-7xl">
      <PageHeader
        ...
        actions={<Button variant="primary" size="sm">Export CSV</Button>}
      />

      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard label="Fuel Efficiency" value="8.4 km/L" hint="Distance / fuel" accent />
        <StatCard label="Fleet Utilization" value="81%" hint="Vehicles in active use" />
        <StatCard label="Operational Cost" value="Rs 34,070" hint="Fuel + maintenance" />
        <StatCard label="Vehicle ROI" value="14.2%" hint="Revenue adjusted return" />
      </div>
